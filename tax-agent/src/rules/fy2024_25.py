...
OLD_REGIME_SLABS: List[Tuple[float, float]] = [
    (300000, 0.0),    # Up to 2.5L no tax
    (600000, 0.05),   # 2.5L to 5L 5%
    (900000, 0.15),  # 5L to 10L 20%
    (1500000, 0.20),  # 10L to 15L 25%
    (float('inf'), 0.30)  # Above 10L 30%
]

NEW_REGIME_SLABS: List[Tuple[float, float]] = [
    (400000, 0.0),    # Up to 3L no tax
    (800000, 0.05),   # 3L to 6L 5%
    (1200000, 0.10),   # 6L to 9L 10%
    (1600000, 0.15),  # 9L to 12L 15%
    (2000000, 0.20),  # 12L to 15L 20%
